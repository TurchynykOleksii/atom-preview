...
const radioPhoneEl = document.querySelector(".form__radio-phone");
const radioEmailEl = document.querySelector(".form__radio-email");
const phoneInputEl = document.querySelector(".form__phone");
const emailInputEl = document.querySelector(".form__email");
const radioPhonePoppupEl = document.querySelector(".poppup__phone-js");
const radioEmailPoppupEl = document.querySelector(".poppup__email-js");
const phoneInputPoppupEl = document.querySelector(".poppup__phone");
const emailInputPoppupEl = document.querySelector(".poppup__email");
...
radioEmailEl.addEventListener("change", () => {
  if (emailInputEl.classList.contains("form__hide")) {
    phoneInputEl.classList.add("form__hide");
    emailInputEl.classList.remove("form__hide");
  } else {
    phoneInputEl.classList.remove("form__hide");
  }
});
radioPhoneEl.addEventListener("change", () => {
  if (phoneInputEl.classList.contains("form__hide")) {
    emailInputEl.classList.add("form__hide");
    phoneInputEl.classList.remove("form__hide");
  } else {
    phoneInputEl.classList.add("form__hide");
  }
